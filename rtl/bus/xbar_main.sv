...
module xbar_main (
  ...
  assign tl_pwm0_o = tl_s1n_24_ds_h2d[10];
  assign tl_s1n_24_ds_d2h[10] = tl_pwm0_i;

  assign tl_uart0_o = tl_s1n_24_ds_h2d[11];
  assign tl_s1n_24_ds_d2h[11] = tl_uart0_i;

  assign tl_uart1_o = tl_s1n_24_ds_h2d[12];
  assign tl_s1n_24_ds_d2h[12] = tl_uart1_i;

  assign tl_uart2_o = tl_s1n_24_ds_h2d[13];
  assign tl_s1n_24_ds_d2h[13] = tl_uart2_i;

  assign tl_i2c0_o = tl_s1n_24_ds_h2d[14];
  assign tl_s1n_24_ds_d2h[14] = tl_i2c0_i;

  assign tl_i2c1_o = tl_s1n_24_ds_h2d[15];
  assign tl_s1n_24_ds_d2h[15] = tl_i2c1_i;

  assign tl_spi0_o = tl_s1n_24_ds_h2d[16];
  assign tl_s1n_24_ds_d2h[16] = tl_spi0_i;

  assign tl_spi1_o = tl_s1n_24_ds_h2d[17];
  assign tl_s1n_24_ds_d2h[17] = tl_spi1_i;

  assign tl_spi2_o = tl_s1n_24_ds_h2d[18];
  assign tl_s1n_24_ds_d2h[18] = tl_spi2_i;

  assign tl_spi3_o = tl_s1n_24_ds_h2d[19];
  assign tl_s1n_24_ds_d2h[19] = tl_spi3_i;
  ...
  tlul_socket_1n #(
    ...
    .DReqPass  (22'h1f02a7),
    .DRspPass  (22'h1f02a7),
    .DReqDepth (88'h1000001111110101011000),
    .DRspDepth (88'h1000001111110101011000),
    .N         (22)
  ) u_s1n_24 (
    .clk_i        (clk_sys_i),
    .rst_ni       (rst_sys_ni),
